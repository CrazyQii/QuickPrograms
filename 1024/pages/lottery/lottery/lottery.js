...
Page({
  ...
  getLottery() {
    ...
    let awardIndex = this.data.awardIndex, 
    ...
    winAwards.data.push(awardsConfig.awards[awardIndex].id)
    ...
    if (this.data.lotteryTimes == 0) { // 抽奖次数使用完毕
